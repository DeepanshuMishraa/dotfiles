return {
	...
	},
	{
		...
		event = { "BufReadPost" },
		cmd = { "LspInfo", "LspInstall", "LspUninstall", "Mason", "LspRestart" },
		dependencies = {
		...
		config = function()
			local map_lsp_keybinds = require("dipxsy.keymaps").map_lsp_keybinds
			...
			-- :LspRestart command - restart LSP for current buffer
