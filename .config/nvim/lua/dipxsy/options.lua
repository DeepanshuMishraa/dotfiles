...
-- Hide the built-in sign column; signs (vcsigns, etc.) are rendered by snacks.statuscolumn
...
local treesitter_group = vim.api.nvim_create_augroup("dipxsy-treesitter-main", { clear = true })
