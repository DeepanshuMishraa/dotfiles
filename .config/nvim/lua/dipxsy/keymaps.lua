...
local prelude = require("dipxsy.prelude")
...
vim.keymap.set("n", "<leader>ww", function()
	...
	Snacks.notify.info("Word wrap: " .. (vim.wo.wrap and "on" or "off"))
...
-- <leader>f moved to telescope.lua (jj-aware with fallback)
...
M.map_lsp_keybinds = function(buffer_number)
	...
	vim.keymap.set("n", "<leader>.", vim.lsp.buf.definition, { desc = "LSP: Go to definition", buffer = buffer_number })
	vim.keymap.set(
		"n",
		"gr",
	...
	vim.keymap.set("n", "K", toggle_hover, { desc = "LSP: Toggle hover documentation", buffer = buffer_number })
...
-- Remote SSH keybinds
local remote = require("dipxsy.remote")

vim.keymap.set("n", "<leader>rh", function()
	remote.show_hosts_picker()
end, { desc = "SSH: browse remote hosts" })
